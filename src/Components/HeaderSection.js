    ...
    return (
        <div className="flex justify-center md:items-center flex-col">
            ...
            <div
                ...
                className={`hidden w-full  md:overflow-hidden py-10 px-[50px] lg:px-[155px] z-20 md:flex flex-row justify-between items-center left-0 top-0 right-0 fixed h-16 text-black`}
            >
                <div className="  ">
